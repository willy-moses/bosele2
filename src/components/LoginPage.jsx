    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="staff@bosele.org.bw"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-emerald-600 to-green-600 text-white py-3 rounded-xl font-semibold hover:from-emerald-700 hover:to-green-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              {loading ? (
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <GoogleIcon />
            Sign in with Google
          </button>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="mailto:admin@bosele.org.bw" className="text-emerald-600 hover:text-emerald-700 font-medium">
                admin@bosele.org.bw
              </a>
            </p>
          </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>© 2025 Bosele Kgotla VDC. All rights reserved.</p>
          <p className="mt-1">Secure staff portal • Protected by encryption</p>
        </div>
      </div>
    </div>
  )
